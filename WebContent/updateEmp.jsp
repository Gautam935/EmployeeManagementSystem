...
<html>
    ...
    <body>
        <div id="container">
            ...
            <caption style="font-weight: bold; font-size: 17px;">EMPLOYEE'S UPDATE</caption>
            ...
            <tr><td>DEPARTMENT</td><td><input type=text name='dept' size='40'/></td></tr>
            ...
            <p><input type='reset' name='clear' value='CLEAR'/><input type='submit' name='rest' value='UPDATE'/></p>
            </form>
         </div>
         </div>
         </div>
